 ...
 * This fragment is either contained in a {@link DecorListActivity}
...
public class DecorDetailFragment extends Fragment {
     ...
     */
    private DecoreContent.DummyItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = DecoreContent.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
